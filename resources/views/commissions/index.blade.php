...
<div class="grid grid-cols-1 gap-4 md:gap-6">
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 text-center">
        <h2 class="mb-3 text-2xl font-semibold text-gray-800 dark:text-white/90">My Commissions</h2>
        <p class="mb-6 text-gray-500 dark:text-gray-400">Track all your earnings from joined referrals and orders.</p>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <h3 class="mb-5 text-xl font-semibold text-gray-800 dark:text-white/90">Commission History</h3>
        
        <div class="overflow-x-auto">
            <table id="commissions-table" class="w-full text-left">
                <thead>
