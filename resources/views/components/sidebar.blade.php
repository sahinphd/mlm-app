        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              ...
              :class=" (page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks' || page === 'dashboard') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks' || page === 'dashboard') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <!-- Menu Item Admin EMIs -->
          <li>
            <a
              href="{{ route('admin.emis.index') }}"
              class="menu-item group"
              :class=" (page === 'admin_emis') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <!-- Menu Item Wallet Transfer -->
          <li>
            <a
              href="{{ route('wallet.transfer') }}"
              class="menu-item group"
              :class=" (page === 'wallet_transfer') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <!-- Menu Item EMI Schedule -->
          <li>
            <a
              href="{{ route('credit.emis') }}"
              class="menu-item group"
              :class=" (page === 'emi_schedule') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <!-- Menu Item Penalty History -->
          <li>
            <a
              href="{{ route('credit.penalties.history') }}"
              class="menu-item group"
              :class=" (page === 'penalty_history') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <a
              href="{{ route('profile.id-card') }}"
              class="menu-item group"
              :class=" (page === 'profile_id') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
