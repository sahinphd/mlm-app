    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            ...
            <div class="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="mb-4 h-48 w-full bg-gray-2 dark:bg-meta-4 flex items-center justify-center">
                    PKG
                </div>
                <div>
                    ...
                    <a href="{{ route('shop.checkout', ['package_id' => $package->id]) }}" class="flex w-full justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90">
                        Buy Package
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            ...
            <div class="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div>
                    ...
                    <a href="{{ route('shop.checkout', ['product_id' => $product->id]) }}" class="flex w-full justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90">
                        Buy Now
                    </a>
                </div>
            </div>
