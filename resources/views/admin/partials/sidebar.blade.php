				...
				<ul class="mb-6 flex flex-col gap-1.5">
					...
					@can('admin-access')
						@php
							...
							render_admin_menu_item(route('payments.admin'), 'Payments', '<path d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>', ['admin/payments*'], $badge);
