                    ...
                    <tr>
                        ...
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            <div class="flex items-center gap-2">
                                ...
                                @if($emi->user && $emi->user->phone && $emi->status !== 'paid')
                                    @php
                                    ...
                                    @endphp
                                    <a href="{{ $whatsappUrl }}" target="_blank" class="inline-flex items-center justify-center rounded bg-[#25D366] py-1.5 px-3 text-center text-xs font-medium text-white hover:bg-opacity-90" title="Send WhatsApp Reminder">
